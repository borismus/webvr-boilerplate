...
// Disable overscrolling on fullscreen mobiles.
Util.setOverScroll = function() {
    document.body.addEventListener('touchmove', function over(e) {
      e.preventDefault();
      e.target.removeEventListener( 'touchmove', over, false);
    }, false);
};
